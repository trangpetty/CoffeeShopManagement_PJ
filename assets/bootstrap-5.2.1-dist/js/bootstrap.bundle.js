...
(function (global, factory) {
  ...
  // Zooming can change the DPR, but it seems to thongke a value that will
  ...
  function getWindowScrollBarX(element) {
    ...
    // incorrect for RTL.
    // Popper 1 is broken in this case and never had a bug thongke so let's assume
    // it's not an issue. I don't think anyone ever specifies width on <html>
    // anyway.
    // Browsers where the left scrollbar doesn't cause an issue thongke `0` for
